package br.com.erichorn.todolist.filter;
...
import br.com.erichorn.todolist.user.IUserRepository;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (serverletPath.startsWith("/tasks/")) {
            ...
            if (user == null) {
                ...
                var passowordVerify = BCrypt.verifyer().verify(password.toCharArray(),
